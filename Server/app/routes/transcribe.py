...
def register_transcribe_route(app):
    ...
    def get_result():
        ...
        def process_transcription(json_data):
            output = [{'text': segment['text'], 'start': segment['start'], 'end': segment['end']} for segment in json_data]
            return output
        
        json_file_path = 'results\output.json'  # Update this path as needed
        json_data = read_json(json_file_path)
        output = process_transcription(json_data)
